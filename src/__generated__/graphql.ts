...
export type FetchMeQuery = { __typename?: 'Query', me: { __typename?: 'User', id: string, name: string, email: string } };
...
export type UserGroupUsersQuery = { __typename?: 'Query', userGroupUsers: { __typename?: 'UserGroupUserResponse', total?: number | null, users: Array<{ __typename?: 'UserGroupAssignee', id: string, name: string, email: string, avatarUrl?: string | null, isAssigned: boolean }> } };
...
export type FetchUserQuery = { __typename?: 'Query', users: { __typename?: 'UsersResponse', users?: Array<{ __typename?: 'User', id: string, name: string, email: string, avatarUrl?: string | null, isSuperAdmin?: boolean | null, isApUser?: boolean | null, isBackOfficeUser?: boolean | null, isEmailVerified?: boolean | null, userGroups?: Array<{ __typename?: 'UserGroup', id: string, name: string, createdAt?: any | null, permissions: { __typename?: 'UserGroupPermission', Account: UserGroupRole, ApprovalAmount: number, BankAccount: UserGroupRole, BatchUpload: UserGroupRole, CreditCard: UserGroupRole, Customer: UserGroupRole, Report: UserGroupRole, Vendor: UserGroupRole }, organization?: { __typename?: 'Organization', id: string, name: string, slug: string, email?: string | null, avatarUrl?: string | null } | null }> | null } | null> | null } };
