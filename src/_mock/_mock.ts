...
export const _mock = {
  ...
  // Image
  image: {
    cover: (index: number) => `${ASSETS_URL}/assets/images/cover/cover_${index + 1}.jpg`,
    avatar: (index: number) => `${ASSETS_URL}/assets/images/avatar/avatar_${index + 1}.jpg`,
    travel: (index: number) => `${ASSETS_URL}/assets/images/travel/travel_${index + 1}.jpg`,
    company: (index: number) => `${ASSETS_URL}/assets/images/company/company_${index + 1}.png`,
    product: (index: number) => `${ASSETS_URL}/assets/images/m_product/product_${index + 1}.jpg`,
    portrait: (index: number) => `${ASSETS_URL}/assets/images/portrait/portrait_${index + 1}.jpg`,
  },
};
